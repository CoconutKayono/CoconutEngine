...
{
    [CustomEditor(typeof(PlayAudioNotifyState))]
    public sealed class PlayAudioNotifyStateEditor : UnityEditor.Editor
    {
        public override VisualElement CreateInspectorGUI()
        {
            ...
            root.Add(ActionNotifyInspectorElements.BuildHelpBox(
                "可从 Project 将 AudioClip 拖到「音效轨道」，或指定 Source Audio Clip 后点 From Audio Clip。"));
        ...
        {
            var state = (PlayAudioNotifyState)target;
        ...
        private void PreviewSelected()
        {
            ...
            ActionTimelinePreviewRuntime.PreviewAudio(state.EffectiveClips, state.dontPlayProbability, owner);
        }
    }
}
