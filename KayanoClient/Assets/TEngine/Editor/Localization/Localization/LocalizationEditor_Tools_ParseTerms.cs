		...
		void OnGUI_Tools_ParseTerms()
		{
			...
			GUILayout.Space (5);
				...
				GUILayout.FlexibleSpace();
					...
					GUILayout.FlexibleSpace();
					mParseTermsIn_Scripts = GUILayout.Toggle(mParseTermsIn_Scripts, new GUIContent("Parse SCRIPTS", "Searches all .cs files and counts all terms like: ScriptLocalization.Create(\"xxx\")"));
