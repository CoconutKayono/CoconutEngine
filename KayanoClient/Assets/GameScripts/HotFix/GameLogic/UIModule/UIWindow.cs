...
namespace GameLogic
{
    public abstract class UIWindow : UIBase
    {
        ...
        /// 移动设备屏幕适配
        /// </summary>
        /// <param name="fitRect">需要适配的RectTransform对象</param>
        /// <param name="liuHaiFit">是否适配刘海屏</param>
        /// <param name="topSpacing">刘海屏适配顶部偏移高度</param>
        /// <param name="bottomFit">是否适配底部黑边</param>
        /// <param name="bottomSpacing">底部黑边适配偏移高度</param>
        ...
        /// <summary>
        /// 设置某一节点不受指定RectTransform的影响
        /// </summary>
        /// <param name="rect">被设置的RectTransform</param>
        /// <param name="refRect">参考的RectTransform</param>
        ...
        /// 处理资源加载完成回调
        /// </summary>
        /// <param name="panel">加载的资源实例</param>
