...
namespace Procedure
{
    /// <summary>
    /// 流程 => 加载热更程序集。
    /// <para>【流程位置】Preload 之后，StartGame 之前；HybridCLR 热更链路核心步骤。</para>
    /// <para>【职责】LoadMetadataForAOTAssembly 补充 AOT 泛型元数据；YooAsset 加载 GameProto/GameLogic.dll.bytes 并 Assembly.Load；反射调用 GameApp.Entrance 进入热更域。</para>
    /// <para>【下一流程】→ ProcedureStartGame。</para>
    /// <para>【术语】HybridCLR：IL2CPP 热更；AOTMetaAssemblies：需补元数据的 AOT DLL；LogicMainDllName：入口程序集 GameLogic.dll。</para>
    /// </summary>
