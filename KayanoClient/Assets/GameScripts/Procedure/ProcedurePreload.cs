...
namespace Procedure
{
    /// <summary>
    /// 流程 => 预加载资源。
    /// <para>【流程位置】资源 Manifest 就绪且（无需下载或下载已完成）之后，LoadAssembly 之前。</para>
    /// <para>【职责】按 YooAsset 标签 PRELOAD（WebGL 另含 WEBGL_PRELOAD）异步加载常用资源到内存，减少进游戏卡顿。</para>
    /// <para>【下一流程】全部 PRELOAD 完成 → ProcedureLoadAssembly。</para>
    /// <para>【术语】PRELOAD：资源标签；LoadAssetCallbacks：TEngine 异步加载回调；EditorSimulateMode 跳过预加载。</para>
    /// </summary>
